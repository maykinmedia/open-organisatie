...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       git clone git@bitbucket.org:maykinmedia/openorganisatie.git
       cd openorganisatie
...
``src/openorganisatie/conf/local.py``. You can base this file on the
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       docker-compose up -d
       Starting openorganisatie_db_1 ... done
       Starting openorganisatie_web_1 ... done
   ...
   .. code-block:: bash
       ...
       docker logs -f openorganisatie_web_1
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       docker exec -it openorganisatie_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       docker exec -it openorganisatie_web_1 /app/src/manage.py loaddata admin_index groups
...
.. _Github: https://github.com/maykinmedia/openorganisatie/
...
environment variables. See ``src/openorganisatie/conf/docker.py`` for
all settings.

.. code-block:: bash

    docker build -t openorganisatie
    docker run \
        -p 8000:8000 \
        -e DATABASE_USERNAME=... \
        -e DATABASE_PASSWORD=... \
    ...
    docker exec -it openorganisatie /app/src/manage.py createsuperuser
