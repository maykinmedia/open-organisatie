...
Open Organisatie makes use of quite a bit of Continuous Integration tooling to
...
the ``main`` branch belonging to the `Maykin`_ organisation on Github.
...
Tagging will ensure that a Docker image ``maykinmedia/open-organisatie:1.0.0`` is published.
