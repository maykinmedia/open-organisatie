...
This installation is meant for people who want to just try out Open Organisatie on
their own machine.
...
* Runs against the latest version of Open Organisatie, which may contain bugs.
...
1. Download the project as ZIP-file:
   ...
   .. code:: bash
      ...
      $ wget https://github.com/maykinmedia/open-organisatie/archive/refs/heads/main.zip -O main.zip
      $ unzip main.zip
      $ cd open-organisatie-main
...
2. Start the docker containers with ``docker compose``. If you want to run the
   ...
   .. code:: bash
      ...
      [+] Running 5/5
       ⠿ Network open-organisatie-main_default    Created      0.0s
       ⠿ Container open-organisatie-main-db-1     Created      0.2s
       ⠿ Container open-organisatie-main-web-1    Created      0.1s
