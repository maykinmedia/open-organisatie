...
Updating an Open Organisatie installation
=========================================

Software receives new features and bugfixes all the time, and Open Organisatie is no different.
At some point, you'll want to update to a newer version of Open Organisatie - be it a patch
