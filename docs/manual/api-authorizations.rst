...
De API's die Open Organisatie aanbied zijn niet toegankelijk
...
de beheer omgeving van de Open Organisatie. Binnen de beheer omgeving kan men onder
de menu optie **Users** de link **Tokens** vinden. Deze link lijdt naar de lijstweergave
van alle aangemaakte Tokens waarmee toegang mogelijk is naar de API's van Open Organisatie.
