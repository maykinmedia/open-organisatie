        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voornaam",
                    models.CharField(
                        help_text="Voornaam van de medewerker.", max_length=100
                    ),
                ),
                (
                    "achternaam",
                    models.CharField(
                        help_text="Achternaam van de medewerker.", max_length=100
                    ),
                ),
                (
                    "emailadres",
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Datum waarop de medewerker uit dienst is gegaan (indien van toepassing).",
                        null=True,
                    ),
                ),
                (
