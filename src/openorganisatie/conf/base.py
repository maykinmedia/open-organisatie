...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "openorganisatie.utils.context_processors.settings",
            ],
...
DEFAULT_FROM_EMAIL = "openorganisatie@example.com"
...
LOGGING = {
    ...
    "formatters": {
        ...
        "verbose": {
            "format": "%(asctime)s %(levelname)s %(name)s %(module)s %(process)d "
            "%(thread)d  %(message)s"
        },
    ...
    "handlers": {
        ...
        "console": {
            ...
            "formatter": config(
                ...
                default="json",
                help_text=(
                    "The format for the console logging handler, possible options: "
                    "``json``, ``plain_console``."
                ),
                group="Logging",
            ),
...
AUTHENTICATION_BACKENDS = [
    ...
    "openorganisatie.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "openorganisatie_sessionid"
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "openorganisatie"
