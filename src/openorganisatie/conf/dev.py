...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-scl%uga+2ji^oa)1_*bdm^40dpn4*+gw83mw3a5=6l4(k%b$y&",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "openorganisatie")
os.environ.setdefault("DB_USER", "openorganisatie")
